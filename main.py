                ...
                if os.path.exists('temp_command.txt'):
                    ...
                    if command:
                        ...
                        # معالجة أمر تطبيق زي محفوظ
                            ...
                            result = await commands_handler.handle_command(fake_user, command)
    ...
    async def on_chat(self, user: User, message: str) -> None:
        ...
        try:
            ...
            if message == "السلام عليكم":
                ...
                from modules.commands_handler import CommandsHandler
                commands_handler = CommandsHandler(self)
                result = await commands_handler.handle_command(user, message)
                if result:
                    await self.highrise.chat(result)
        ...
        try:
            ...
            if isinstance(response, GetMessagesRequest.GetMessagesResponse):
                if response.messages:
                    ...
                    # فحص إذا كانت الرسالة "هلا" أولاً قبل فحص الصلاحيات
                    ...
                    if not (is_developer or is_owner):
                        await self.highrise.send_message(conversation_id, "❌ الرسائل الخاصة متاحة للمطورين فقط")
                        return
                        ...
                        await self.highrise.send_message(conversation_id, "💬 تم استلام رسالتك. استخدم '/لبس [أكواد]' أو '/خلع [كود]' أو 'هلا' للمساعدة")
